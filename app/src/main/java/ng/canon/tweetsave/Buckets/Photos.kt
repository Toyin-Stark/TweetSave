package ng.canon.tweetsave.Buckets
...
import ng.canon.tweetsave.GlideApp
import ng.canon.tweetsave.R
import java.io.File
import java.util.*

class Photos : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = getString(R.string.saved)
        toolbar.title = title
    ...
    fun FileQuery() {
        ...
        arrayList!!.clear()
        path = Environment.getExternalStorageDirectory().absolutePath + "/twittersave/"
        ...
        observable!!.subscribeOn(Schedulers.io())
                ...
                .subscribe(object: Observer<String> {
                    override fun onComplete() {
                        ...
                        adapter = Photo_Adapter(applicationContext, arrayList!!, this@Photos)
...
class Photo_Adapter(var context: Context, var arraylists: ArrayList<Photo_Model>, var downloads:Photos) :
    ...
    class Item(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindData(_data: Photo_Model, _cube: Photos) {
